...
define('CACHE_TIME_INDEX_FOCUS_IMAGE',30*86400);   //首页焦点图缓存时间
...
define('CACHE_TIME_PC_INDEX_PRODUCT_INFO',30*86400);// PC首页产品信息
...
define('FRONT_HOST', 'http://yueyawang.com');
...
//产品浏览记录cookie的key值
define('PRODUCT_HISTORY_KEY', 'recentBrowseProd');