...
<div class="course-bar">
     ...
     <li><a href="/index/medical" class="course-active">医考技考</a></li>
    </ul>
     
     <div class="course-list">
          <div class="course-container">
               <ul class="medical-list clearfix">
<?php foreach($category as $cat_id => $cat_name):?>
<li <?php if ($cid == $cat_id) echo 'class="medical-active"'?>><a href="/index/medical/<?php echo $cat_id?>"><?php echo $cat_name?></a></li>
<?php endforeach;?>
               </ul>
          </div>
 <!--         
          <div class="medical-information">
               ...
               <li>
               <div class="medical-lb">
                   <div class="medical-xh"><span>序号</span></div>
                   <div class="medical-dt"><span>考试动态</span></div>
                   <div class="medical-cz"><span>操作</span></div>
               </div>
               </li>
<?php 
...
foreach($article_list as $article):?>
               <li>
               <div class="medical-lb">
               <div class="medical-xh"><?php echo $article->article_id?></div>
                   <div class="medical-dt"><?php echo $article->title?></div>
                   <div class="medical-cz">
<?php if($is_login):?>
<a href="" class="btn bt-com btn-blue">了解详情</a>
<?php else:?>
                   <a href="#login-box" data-toggle="modal" class="no-login btn">未登陆</a>
<?php endif;?>
</div>
               </div>
               </li>
<?php endforeach;endif;?>
  ...
  -->   
          ...
          <div class="course-container kqjx">
               ...
               <a href="#" class="filter-bt current-bt"><?php echo $category[$cid]?></a>
               </div>
