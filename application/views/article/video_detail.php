...
<div class="contain">
        <div class="pro_detail_inner">
             <span class="current-position">当前位置：<a href="/">首页</a>-<a href="/article" class="current-color">悦牙百科</a>-<a href="/article/video">牙科视频</a>-<a href="#"><?=$category2?></a></span>
             <div class="wikipedia clearfix">
                  <div class="wikipedia-left">
                      <div class="wikipedia-sp"><?php echo $article->post_content;?></div>
                  ...
                  <div class="hottest-articles">
                       <div class="hottest-tit">最热视频</div>
                       <div class="hottest-lb">
                           <?php foreach($relative_articles as $rt): ?>
                            <dl class="clearfix">
                                <dt><a href="/article/video_detail/<?=$rt->post_id?>"><img src="<?php echo $rt->cover?>" width="140" height="78" alt=""/></a></dt>
                            <dd>
                                <span class="hott-bt"><a href="/article/video_detail/<?=$rt->post_id?>"><?=$rt->post_title?></a></span>
                               <div class="hottest-ico">
                                    <span><i class="yybk-com-ico sp-ico"></i><em><?php echo get_page_view('article',$rt->post_id);?>次</em></span>
