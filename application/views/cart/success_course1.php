...
<div class="pay-page">
    <div class="Mall_list paytop">
        <div class="course-ico course-ico2"></div>
        <div class="paybox">
            <div class="paywhite">
                <?php 
                $pay_id = 0;
                    ...
                    <div class="pay-lb clearfix">
                        <div class="order-collect clearfix">
                            ...
                            <div class="money">
                                ...
                                <div class="ordersn">订单编号：<strong><?=$order->order_sn?></strong></div>
                            </div>
                        </div>
                        <div id="goods-detail" class="goods-detail" >
                          <div class="pay-buy clearfix">
                                <span class="fl">购买商品：</span>
                                <p class="fl buyxx">
                                    <?php foreach($order->product_list as $k => $product): ?>
                                    <span><?=$k+1?>.<?=$product->product_name?></span>
                                    <?php endforeach; ?> 
                                </p>
                         </div>
                ...
                <div class="platform">
                    ...
                    <a href="javascript:void(0);" class="submit-button cd-popup-trigger4" onclick="j_order_pay('<?php print implode('-', array_keys($order_list)); ?>');">立即支付</a>
                </div>
...
<div id="h_pay" class="cd-popup">
    <div class="cd-popup-container">
        <div class="detel-tit">支付提示</div>
        <div class="cart-bg">
          <div class="cart-bg-jl">
               <p class="cart-del-wz">请在新打开的支付平台页面进行支付<br/>支付完成前请不要关闭该窗口！</p>
               <div class="cart-btn">
                    <a href="javascript:void(0);" class="determine zfcg pay_success">支付成功</a>
                    <a href="javascript:void(0);" class="see-you pay_question">遇到问题？</a>
               </div>         
          </div>     
     </div>
...
<div id="h_pay_fail" class="cd-popup">
    <div class="cd-popup-container">
        <div class="detel-tit">支付遇到问题</div>
        <div class="cart-bg">
          <div class="cart-bg-jl">
               您可以：
               <p class="cart-del-wz2">1、悦牙网帮助中心客服电话：<a href="javascript:void(0);">400-9905-920</a><br/>2、支付宝帮助中心 客服电话：<a href="javascript:void(0);">95188</a></p>                        
          </div>     
     </div>
     <a href="javascript:void(0);" class="cd-popup-close"></a>
    </div>
...
<script>
    ...
    var v_sn = '<?php echo $pay_track->track_sn?>';
        ...
        $.ajax({
                ...
                success:function(data){
                        if(data == 'success') {
                            ...
                            window.location.href='/pay/success_return/'+v_sn;
                        } else {
                                reportCount++;
    ...
    $(".pay_question").click(function(){
        $('#h_pay').removeClass('is-visible');
        $('#h_pay_fail').addClass('is-visible');
    });
    
    //点击立即支付
    function j_order_pay(p_order_ids){
        $('#h_pay').addClass('is-visible');
