...
<link href="<?php echo static_style_url('new_pc/user_style/bootstrap.css?v=version')?>" rel="stylesheet" type="text/css">
<link href="<?php echo static_style_url('new_pc/user_style/common.css?v=version')?>" rel="stylesheet" type="text/css">
<link href="<?php echo static_style_url('new_pc/user_style/personal.css?v=version')?>" rel="stylesheet" type="text/css">
<script src="<?php echo static_style_url('new_pc/user_style/common.js?v=version')?>" type="text/javascript" ></script>
<script src="<?php echo static_style_url('new_pc/user_style/bootstrap.min.js?v=version')?>" type="text/javascript" ></script>
<script src="<?php echo static_style_url('new_pc/user_style/search.js?v=version')?>" type="text/javascript"></script>
<script>
  //页面加载完成执行
  $(function(){
...
<body>
    ...
    <div class="nav-wrap min-wrapper">
        <div class="nav2 clearfix">
            <a href="/" class="logo"><img width="138" height="40" src="<?php echo static_style_url('new_pc/images/login_logo.png?v=version');?>" alt="悦牙网"></a>
            <div class="nav-right2">
                ...
                <div class="nav-lb">
                    ...
                    <?php if($this->session->userdata('user_id')){ ?>
                        <img src="<?php echo static_style_url('mobile/touxiang/'.$this->session->userdata('advar').'?v=version')?>" height="28">
